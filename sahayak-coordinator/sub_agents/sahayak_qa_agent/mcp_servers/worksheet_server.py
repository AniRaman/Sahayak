# """
# Worksheet Server for Sahayak Worksheet Agent
# Extracts content from uploaded files/images and generates questions by difficulty.
# """
...
#             return [
#                 Resource(
#                     uri="worksheet://upload",
#                     name="Worksheet Upload",
#                     description="Upload a file or image to extract content for question generation.",
...
#                     description="Extracts text from an uploaded file or image.",
#                     inputSchema={
#                         "type": "object",
#                         "properties": {
#                             "file_content": {"type": "string", "description": "Content of the uploaded file (base64 or text)"},
#                             "file_type": {"type": "string", "description": "MIME type of the uploaded file (e.g., image/png, text/plain)"}
#                         },
...
#                     description="Generates easy, medium, and hard questions from extracted content.",
#                     inputSchema={
#                         "type": "object",
#                         "properties": {
...
#                 content = await extract_content_from_upload(file_content, file_type)
#                 return [TextContent(type="text", text=content)]
#             elif name == "generate_questions_by_difficulty":
#                 content = arguments["content"]
#                 questions = await generate_questions_by_difficulty(content)
...
#         return "Error: Unable to extract content from the uploaded file."

# async def generate_questions_by_difficulty(content: str) -> str:
#     try:
#         model = genai.GenerativeModel("gemini-2.0-flash")
#         prompt = (
#             "Given the following educational content, generate three questions for each difficulty level: easy, medium, and hard. "
#             "Label each question with its difficulty. Only use the provided content.\n\n"
#             f"CONTENT:\n{content[:4000]}\n\n"
#             "QUESTIONS:"
#         )
...
#         return "Error: Unable to generate questions from the content."
...
# # Configure Gemini API key securely from environment
...
#             return "❌ No valid educational content provided for question generation."

#         model = genai.GenerativeModel("gemini-2.0-flash")
#         prompt = (
#             "You are an academic assistant.\n\n"
#             "Using the following extracted educational content, generate three levels of questions: Easy, Medium, and Hard.\n"
#             "Only base the questions on the given content. Do NOT generate dummy or unrelated questions.\n\n"
#             f"CONTENT:\n\"\"\"\n{content[:4000]}\n\"\"\"\n\n"
#             "QUESTIONS FORMAT:\n"
#             "Easy:\n1. ...\n2. ...\n3. ...\n\n"
#             "Medium:\n1. ...\n2. ...\n3. ...\n\n"
...
#                 Tool(
#                     name="generate_questions_by_difficulty",
#                     description="Generates easy, medium, and hard questions and PDFs from content.",
#                     inputSchema={
#                         "type": "object",
#                         "properties": {
#                             "content": {"type": "string", "description": "Extracted text content"}
...
#             elif name == "generate_questions_by_difficulty":
#                 content = arguments["content"]
#                 result = await generate_questions_by_difficulty(content)
...
#         prompt = (
#             "You are an academic assistant.\n"
#             "Using the following educational content, generate structured assignments:\n\n"
#             "For each of the 3 difficulty levels (Easy, Medium, Hard):\n"
#             "- Generate 5 Multiple Choice Questions (MCQs)\n"
#             "- Generate 3 Descriptive Questions\n"
#             "- Label the sections properly.\n"
...
#         # Save as 3 separate PDFs (if you want individual, here single PDF for all)
#         pdf_path = save_questions_as_pdf("Assignment Worksheet", output, "worksheet_assignment.pdf")
#         return f"📘 Assignment generated successfully.\n\n{output}\n\n📄 Download PDF: {pdf_path}"
#     except Exception as e:
...
# # Public folder to store generated PDFs
...
#                         "type": "object",
#                         "properties": {
#                             "file_content": {"type": "string", "description": "Content of the uploaded file (base64 or plain text)"},
#                             "file_type": {"type": "string", "description": "MIME type of the uploaded file (e.g., image/png, text/plain)"}
#                         },
#                         "required": ["file_content", "file_type"]
#                     }
...
#                 Tool(
#                     name="generate_questions_by_difficulty",
#                     description="Generates easy, medium, and hard questions in a specified language and provides a downloadable assignment PDF.",
#                     inputSchema={
#                         "type": "object",
#                         "properties": {
#                             "content": {"type": "string", "description": "Extracted text content"},
#                             "language": {"type": "string", "description": "Language to generate questions in (default: English)", "default": "English"}
#                         },
#                         "required": ["content"]
#                     }
#                 )
...
#         async def call_tool(self, name: str, arguments: dict) -> List[TextContent]:
#             if name == "extract_content_from_upload":
#                 content = await extract_content_from_upload(arguments["file_content"], arguments["file_type"])
#                 return [TextContent(type="text", text=content)]
#             elif name == "generate_questions_by_difficulty":
#                 content = arguments["content"]
#                 language = arguments.get("language", "English")
#                 result = await generate_questions_by_difficulty(content, language)
#                 return [TextContent(type="text", text=result)]
#             else:
#                 raise ValueError(f"Unknown tool: {name}")
...
#             f"Using the following educational content, generate structured assignments in **{language}**.\n\n"
#             f"For each of the 3 difficulty levels (Easy, Medium, Hard), in **{language}**:\n"
#             f"- Generate 5 Multiple Choice Questions (MCQs) in **{language}**.\n"
#             f"- Generate 3 Descriptive Questions in **{language}**.\n"
#             f"- Label each section clearly in **{language}**.\n"
#             f"- All questions, options, and labels MUST be in **{language}** only.\n"
#             f"- Do NOT use unrelated or generic questions.\n\n"
#             f"CONTENT:\n\"\"\"\n{content[:4000]}\n\"\"\""
#         )
...
#         save_questions_as_pdf("Assignment Worksheet", output, path)
